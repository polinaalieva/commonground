export const CONTENT = {
  ...
  home: {
    en: {
      ...
      body_3: 'Common Ground explores what happens when signals from people are continuously collected to form a living layer of insight about the city.',
    ...
    ru: {
      subtitle_header: 'Изучай места через опыт людей',
        title: 'Common Ground — карта опыта людей о местах',
      subtitle: 'Нажми на карту. Поделись опытом.\nИзучай места через опыт других людей.',
      btn_city: 'Лондон',
      btn_suggest: '+ Предложить город',
      body_1: 'Города собирают огромные массивы данных.',
      body_2: 'Но живой опыт людей — то, как они ощущают места — остаётся фрагментарным, запоздалым и второстепенным.',
      body_3: 'Common Ground исследует, что происходит, когда сигналы от людей собираются непрерывно и формируют живой слой понимания города.',
      contact: 'Если хочешь поделиться обратной связью о проекте, напиши мне в Telegram',
    },
  },
