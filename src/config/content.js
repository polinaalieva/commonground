...
// ===========================
  ...
  map: {
    ...
    living: {
      ...
      ru: {
        // about project (menu button)
        about_text_1: 'Выбирая место для жизни, обычно ориентируешься на советы, статьи или отдельные мнения. Но нет простого способа открыть карту и увидеть, как людям реально живётся в разных районах города.',
